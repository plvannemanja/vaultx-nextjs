        ...
        <div className="flex flex-col gap-y-4 px-4">
            {
                ...
                <>
                    <div className="relative">
                        <Image src={data.collection.bannerImage} alt="hero" width={100} height={100} quality={100} className="w-full object-cover rounded-xl h-[340px]" />
                                            ...
                                            return (
                                                <div className="flex flex-col gap-y-3 w-[20rem]" key={index}>
                                                    <div className="relative cursor-pointer" onClick={() => {
                                                        ...
                                                        <img src={`https://img.youtube.com/vi/${imageId}/0.jpg`} className="w-full aspect-video" />
