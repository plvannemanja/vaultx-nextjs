  ...
  return (
    <div className="flex flex-col gap-y-6 text-white justify-around my-10">
      <div className="flex flex-wrap justify-between px-20 gap-10">
        ...
        <a href="/dashboard?curation">Magazine</a>
        <a href="/dashboard?curation">Who We Are</a>
          ...
          <div className="flex gap-x-3">
            ...
            >
              <Image
                ...
                height={40}
                width={40}
                onMouseEnter={() => setImageHovered({ ...imageHovered, instagram: "/icons/insta_yellow.svg" })}
                onMouseLeave={() => setImageHovered({ ...imageHovered, instagram: "/icons/insta_white.svg" })}
              />
            </a>

            <a target="_blank" href="https://x.com/MonsterX_RWA">
              <Image
                alt="instagram"
                src={imageHovered.X}
                height={40}
                width={40}
                onMouseEnter={() => setImageHovered({ ...imageHovered, X: "/icons/X_yellow.svg" })}
                onMouseLeave={() => setImageHovered({ ...imageHovered, X: "/icons/X_white.svg" })}
              />
            </a>

            <a target="_blank" href="https://www.monsterx.io/">
              <Image
                alt="instagram"
                src={imageHovered.monsterx}
                height={40}
                width={40}
                onMouseEnter={() => setImageHovered({ ...imageHovered, monsterx: "/icons/monsterx_yellow.svg" })}
                onMouseLeave={() => setImageHovered({ ...imageHovered, monsterx: "/icons/monsterx_white.svg" })}
              />
            </a>
          </div>
        </div>
