            ...
            <>
              ...
              <DisclosurePanel className=" pt-4 pb-2 text-sm  text-white  rounded-b-lg">
                <p className="text-[#ffffff53] text-[14px] font-normal azeret-mono-font">
                  {data.description} <span className="text-[#DDF247]">See more</span>
                </p>
              </DisclosurePanel>
            </>
          )}
                ...
                <div className="flex gap-4 flex-wrap">
                  {data.attributes.map((attr, index) => {
                    return (
                      <div
                        key={index}
                        className="w-[153px] h-[93px] py-4 rounded-[12px] flex justify-center flex-col gap-y-2 border border-[#FFFFFF1F]"
                      >
                        <p className="text-[12px] leading-[17px] font-medium text-center text-[#888888]">
                          {attr.type}
                        </p>
                        <p className="font-medium azeret-mono-font text-[14px] text-center">{attr.value}</p>
                      </div>
                    );
                  })}
