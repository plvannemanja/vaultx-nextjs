    ...
    <>
      {step === 1 && (
        <div className="flex flex-col gap-y-4">
          <p className="font-extrabold text-[30px] leading-[40px]">List item for sale</p>
          <ConnectedCard/>

          {/* Blockchain card  */}

          <div className="flex flex-col gap-y-2">
            <p className="text-[#ffffff] text-[16px] azeret-mono-font">Price</p>
            <div className="flex justify-between items-center border border-gray-400 rounded-md p-3 my-1 azeret-mono-font">
              ...
              <svg width="26" height="26" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <defs>
                    <clipPath id="clip0_717_11946"><rect width="54" height="54" fill="white"></rect></clipPath>
                  </defs>
                </svg>
              ...
              {({ open }) => (
                <>
                  <DisclosureButton className="flex w-full justify-between py-2 text-left   text-lg font-medium text-[#fff] text-[18px] border-b border-[#FFFFFF80] ">
                    <span>Give a new price to put this asset for sale.</span>
                    <ChevronUpIcon
                      className={`${
      ...
      {step === 3 && (
        <div className="flex flex-col gap-y-9 items-center text-center">
          ...
          <p className="text-[30px] font-medium leading-[40px]">
            Please wait while we put<br/> it on sale
          </p>
        </div>
      )}
    </>)}
