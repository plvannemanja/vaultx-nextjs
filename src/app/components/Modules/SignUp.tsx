...
const signUpSchema = z.object({
  nickname: z.string()
    ...
    .regex(/^[a-zA-Z0-9_]+$/, { message: "Nick name can only contain alphanumeric characters and underscores" }),
  email: z
    .string()
...
export function SignUpModal() {
  ...
  const [errors, setErrors] = useState<{ nickname?: string; email?: string, axios?: string }>({});
        ...
        step === 1 && (
          <div className="items-center justify-center">
            ...
            <div className="w-[454px] left-[29px] top-[235px] absolute text-[#ff0000] text-sm font-normal font-['Azeret Mono'] leading-snug">
              {(errors.nickname || errors.email) && <p className="text-red-500">*All fields are required.</p>}
