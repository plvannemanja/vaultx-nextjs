  ...
  return (
    <Card className="bg-dark text-white border-none">
      <CardContent className="aspect-square p-3">
        <Image src={data.cloudinaryUrl ? data.cloudinaryUrl : ''} height={100} width={100} className="rounded w-full aspect-[4/3] object-cover" alt="nft-image" loading="lazy" />
        <div className="flex flex-col gap-y-4 my-2">
          ...
          <div className="flex justify-between">
            ...
            <div className="flex gap-x-2 items-center">
              <Image src="/icons/matic.png" height={20} width={20} alt="matic" />
              ${data.price}
            </div>
          </div>
        </div>
