...
export default function ArtistsCard({ image, title, subtitle1, subtitle2 }: { image: string, title: string, subtitle1: string, subtitle2: string }) {
    return (
        <div className="max-w-[30rem] w-[25rem] min-w-[20rem] relative">
            <a className="w-full" href={subtitle2 ? subtitle2 : ""}>
                <Image src={image} width={100} height={100} className="w-full h-full object-cover" alt="artist-pic" />
