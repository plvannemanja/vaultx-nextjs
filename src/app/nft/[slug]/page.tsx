...
export default function Page({ params }: { params: { slug: string } }) {
    ...
    const handleNFTType = async (nft: any, userData: any) => {
      if (nft?.mintedBy?.wallet?.toLowerCase() === userData.wallet?.toLowerCase()) {
        if (
                                    ...
                                    <div className="flex justify-between">
                                        <div className="flex flex-col gap-y-2">
...

                                            {
                                              ...
                                              <div className="flex flex-col gap-y-2 items-center">
                                                ...
                                                <BaseDialog
                                                  ...
                                                  children={<BidModal title={data.name} update={() => {}} />}
...

                                            {
                                              ...
                                              <div className="flex flex-col gap-y-2 items-center">
                                                <BaseDialog 
                                                  ...
                                                  trigger={
                                                    <BaseButton title="Release Escrow" variant="primary" onClick={() => { }} />
                                                  }
...

                                            {
                                              type === 'remove' ? 
                                              <div className="flex flex-col gap-x-2 items-center">
                                                <BaseButton title="Remove From Sale" variant="primary" onClick={() => { }} />
                                              </div> : null
                                            }

                                            {
                                              ...
                                              <div className="flex flex-col gap-x-2 items-center">
                                                <BaseButton title="Cancel Requested" variant="primary" onClick={() => { }} />
                                              </div> : null
                                            }

                                            {
                                              ...
                                              <div className="flex flex-col gap-x-2 items-center">
                                                <BaseDialog
                                                  trigger={
                                                    <BaseButton title="Escrow Release Request" variant="primary" onClick={() => { }} />
                                                  }
...

                                            {
                                              type === 'inEscrow' ? 
                                              <div className="flex flex-col gap-x-2 items-center">
                                                <BaseButton title="In Escrow" variant="primary" onClick={() => { }} />
                                              </div> : null
                                            }
                                        </div>
                                        <div>
                          ...
                          <div className="w-full flex flex-col gap-y-5 mt-5">
                            <div className="w-full rounded-md px-4 py-3 bg-dark flex flex-col gap-y-2">
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        {bids.length > 0 && bids.map((item: any, index: number) => {
                                            return (
                                                <TableRow key={index}>
                                                    ...
                                                    <TableCell>${(2 * item?.bidValue).toLocaleString("en-US")}</TableCell>
                                                    <TableCell>
                                                      {item?.createdAt
                                                    ...
                                                    <TableCell className="text-right">
                                                      {
                                                        ...
                                                        <div className='py-3 min-w-24 rounded-lg text-black font-semibold bg-neon'>
                                                          <button className='w-full h-full' onClick={async() => await cancelBid()}>Cancel Bid</button>
                                                        </div>
                                                        :
                                                        <div className='py-3 min-w-24 rounded-lg text-black font-semibold bg-light'>
                                                          <button className='w-full h-full' onClick={() => {}}>Bidded</button>
                                                        </div>
                                                      }
                                                    </TableCell>
                                                </TableRow>
                                                ...
                                                <TableRow key={index}>
                                                    ...
                                                    <TableCell>
                                                        <div className="flex gap-x-2 items-center text-neon">
                                                            ...
                                                            {
                                                                fromAddress && (
                                                                    <a target="_blank" href={`/address/${fromAddress}`}>
                                                                        <ArrowTopRightOnSquareIcon width={20} height={20} />
                                                                    </a>
                                                                )
                                                            }
                                                    ...
                                                    <TableCell>
                                                        <div className="flex gap-x-2 items-center text-neon">
                                                            ...
                                                            {
                                                                toAddress && (
                                                                    <a target="_blank" href={`/address/${toAddress}`}>
                                                                        <ArrowTopRightOnSquareIcon width={20} height={20} />
                                                                    </a>
                                                                )
                                                            }
